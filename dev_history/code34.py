...
class PINN(nn.Module):
    def __init__(self):
        ...
        self.fourier_embedding = FourierEmbedding(input_dims=5, embed_dims=128, scale=10.0)
...
# --- predictions ------------------------------------------------------------
    ...
    if epoch % N_save_model == 0 and epoch != 0:
        save_model(model, 'c34_15k_plus.pth')
...
def main():
    ...
    writer = SummaryWriter(log_dir='runs/c34_02_lr3')
