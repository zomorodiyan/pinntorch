...
class PINN(nn.Module):
    def __init__(self):
        ...
        self.fourier_embedding = FourierEmbedding(input_dims=5, embed_dims=128,
                                                  scale=1.5)
...
class FourierEmbedding(nn.Module):
    def __init__(self, input_dims, embed_dims, scale=1.5):
...
#   model.load_state_dict(torch.load('./models/c34_15k.pth'))
    ...
    writer = SummaryWriter(log_dir='runs/c35_03_fourier_1.5')
