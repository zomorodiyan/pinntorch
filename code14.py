...
def update_weights(model, inputs, boundary_conditions, initial_conditions, sparse_data, weights):
    ...
    _, loss_components = loss(model, inputs, boundary_conditions, initial_conditions, sparse_data, weights)
...
all_normalized_weights = {
        'pde': torch.tensor(np.array([3.0**-2, 2.0**-2, 3.0**-2, 0.1**-2, 30.0**-2, 0.01**-2])*2, device=device),
        'bc': torch.tensor([3.0**-2, 2.0**-2, 0.1**-2,(30.0)**-2, (3.0*20)**-2, (2.0*20)**-2, (3.0*20)**-2,
                            (0.1*20)**-2, (30*20)**-2, 2.0**-2, 3.0**-2, 3.0**-2, 2.0**-2, 0.1**-2], device=device),
        'ic': torch.tensor([3.0**-2, 2.0**-2, 3.0**-2, 0.1**-2, 30.0**-2, 0.01**-2], device=device),
...
def train_step(model, optimizer, pde_inputs, boundary_conditions, initial_conditions, sparse_data, weights):
    optimizer.zero_grad()
    total_loss, _ = loss(model, pde_inputs, boundary_conditions, initial_conditions, sparse_data, weights)
...
def loss(model, pde_inputs, boundary_conditions, initial_conditions, sparse_data, weights):
